...
<body>
    ...
    <form action="cadastro.php" method="post">
        <fieldset class="margin-border">
            ...
            <h4 class="title">Cadastro de Procedimento</h4>
            <hr>
        ...
        <table class="flex">  
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="dataCadastroProcedimento" id="dataCadastroProcedimento" placeholder="dd/mm/aaaa">
                </td>  
            ...
            <table> 
                <tr>
                    <td>    
                        ...
                        <input type="text" name="nomeProcedimento" id="nomeProcedimento">
                    </td>
                    <td>    
                        <label for="codigoProcedimento">Cod: </label>
                        <input type="text" name="codigoProcedimento" id="codigoProcedimento" style="display:flex;">
                    </td>
            ...
            <td>
                <label for="generoProcedimento">genero: </label>
                <select name="generoProcedimento" style="display:flex;" id="generoProcedimento">
            ...
            <td>
                ...
                <select name="exececaoProcedimentos" style="display:flex;" id="exececaoProcedimentos">
