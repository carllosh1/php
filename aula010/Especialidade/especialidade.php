...
<body>
    ...
    <form action="cadastro.php" method="post">
        <fieldset class="margin-border">
            ...
            <h4 class="title">Cadastro Especialdiades</h4>
            <hr>
        ...
        <table class="flex">  
            <tr >    
                <td>
                    ...
                    <input type="text"  name="dataCadastroEspecialidade" id="dataCadastroEspecialidade" placeholder="dd/mm/aaaa">
                </td>   
            </tr>
        </table> 
        ...
        <table>
            <tr>
                <td>
                    ...
                    <input type="text" name="nomeEspecialidade" id="nomeEspecialidade">
